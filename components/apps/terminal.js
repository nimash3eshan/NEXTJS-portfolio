...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["books", "projects", "personal-documents", "skills", "languages", "crush", "interests"],
            crush: ["you🙈"],
            ...
            skills: ["ReactNative", "React.js", "jQuery", "MongoDB", "Express.js", "SQL", "Firebase"],
            projects: ["NEXTJS-portfolio", "Combook", "Rubber-mixer-machine", "Quixi", "Ecommerce-app", "Srilanka-Wonderland", "Erary"],
            interests: ["Software Engineering", "AI", "Mathematics", "Astronomy"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">nes@Dell</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/nimash")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nimash, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-nimash":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-nimash");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nimash, todoist, trash, settings, sendmsg ]";
                }
                break;
